...
$professor->setNome_professor(mb_strtoupper($nome_professor));
$professor->setNascimento_professor($nascimento_professor);
$professor->setMae_professor(mb_strtoupper($mae_professor));
$professor->setPai_professor(mb_strtoupper($pai_professor));
...
$professor->setCurso_professor(mb_strtoupper($curso_professor));
